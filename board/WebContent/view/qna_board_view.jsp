		...
		<form action="" method="post" role="form">
			<div class="box-body">
						...
						<a href="view/download.jsp?fileName=${vo.attach}">
							<%
								...
								if(attachFullName!=null){
									String attachName = 
											attachFullName.substring(attachFullName.indexOf("_")+1);
									out.print("<a href='view/download.jsp?fileName="+
												URLEncoder.encode(attachFullName,"utf-8")+"'>");
				...
				<div class="box-footer text-center">
					...
					<button type="button" class="btn btn-primary" id="list" onclick="location.href='../list.do'">목록보기</button>
				</div>
				<div style="height:20px"></div>
			</div>
		</form>
