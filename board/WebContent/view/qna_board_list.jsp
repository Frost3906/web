				...
				<nav aria-label="Page navigation example">
				  <ul class="pagination"><!--하단의 페이지 나누기 부분-->
					<c:if test="${pageVO.prev}">
						<li class="page-item">
							<a href="list.do?page=${pageVO.startPage-1}&criteria=${pageVO.search.criteria}&keyword=${pageVO.search.keyword}" class="page-link">Previous</a>
						</li>
					</c:if>
					...
					<c:if test="${pageVO.next}">
						<li class="page-item">
							<a href="list.do?page=${pageVO.endPage+1}&criteria=${pageVO.search.criteria}&keyword=${pageVO.search.keyword}" class="page-link">Next</a>
						</li>
					</c:if>
				  </ul>
				</nav>					
